...
public class NoobChain {
	...
	public static void main(String[] args) {	
		...
		genesisTransaction.outputs.add(new TransactionOutput(genesisTransaction.reciepienter, genesisTransaction.value, genesisTransaction.transactionId)); //manually add the Transactions Output
		...
		System.out.println("\nWalletA is Attempting to send funds (200) to WalletC...");
		block4.addTransaction(walletA.sendFunds( walletC.publicKey, 200));
		System.out.println("\nWalletA's balance is: " + walletA.getBalance());
